...
const TestSvg = dynamic(() => import("./test-svg"), {
  loading: () => (
    <Html>
      <p>Loading...</p>
    </Html>
...
function Pointer({ vec = new Vector3() }) {
  ...
  return (
    <RigidBody type="kinematicPosition" colliders="ball" ref={api}>
      <Sphere receiveShadow castShadow args={[0.25]}>
...
//     // scene.js
//     const setupScene = (container: HTMLHtmlElement) => {
...
//     const { scene, camera, controls } = setupScene(ref.current)
